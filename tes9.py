# Hasil olahRSSI2.py -> (OutputKF.csv) ->OutputTrilaterasiKF.csv
import numpy as np
import pandas as pd

# Baca nilai dari file CSV
csv_file = r'Data Penelitian\Data Final v4\Dinamis\Ruang 2\Ruang Isi\Posisi 1\5\Data benar\outputKF.csv'  # Gunakan r prefix untuk string mentah
output_csv_file = r'Data Penelitian\Data Final v4\Dinamis\Ruang 2\Ruang Isi\Posisi 1\5\Data benar\outputTrilaterasiKF.csv'
